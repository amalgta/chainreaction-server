...
class WebSocketConfig(private val playController: PlayController, private val echoController: EchoController) : WebSocketConfigurer {
    ...
    override fun registerWebSocketHandlers(registry: WebSocketHandlerRegistry) {
        registry.addHandler(playController, "v1/reactive/play").setAllowedOrigins("*").withSockJS()
        registry.addHandler(echoController, "v1/reactive/echo").setAllowedOrigins("*").withSockJS()
    }
}
